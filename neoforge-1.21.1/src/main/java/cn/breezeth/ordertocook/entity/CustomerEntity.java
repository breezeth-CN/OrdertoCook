...
public class CustomerEntity extends Zombie implements GeoEntity {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(SKIN_ACCOUNT, "");
        builder.define(SKIN_UUID, "");
        builder.define(EASTER_EGG, false);
        builder.define(ANIMATION_VARIANT, 1);
        builder.define(CUSTOMER_ID, "");
    ...
    private void tickEatEffects(int actionState, int elapsedTicks) {
        ...
        if (!this.currentActionFinishTriggered && elapsedTicks >= 118) {
            ...
            serverWorld.playSound(null, this.blockPosition(), SoundEvents.GENERIC_EXPLODE.value(), SoundSource.NEUTRAL, 1.0f, 1.0f);
