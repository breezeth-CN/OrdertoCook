...
public class MotorcycleEntity extends Entity implements MenuProvider {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        builder.define(STEERING, 0.0f);
        builder.define(SPEED, 0.0f);
        builder.define(COLOR, 0); // 0: 默认, 1: 红, 2: 蓝, 3: 黄
        builder.define(LIGHT_ENABLED, true);
    }
    ...
    protected void readAdditionalSaveData(CompoundTag nbt) {
        ...
        ContainerHelper.loadAllItems(nbt, this.inventory.getItems(), this.level().registryAccess());
    }
    ...
    protected void addAdditionalSaveData(CompoundTag nbt) {
        ...
        ContainerHelper.saveAllItems(nbt, this.inventory.getItems(), this.level().registryAccess());
    }
