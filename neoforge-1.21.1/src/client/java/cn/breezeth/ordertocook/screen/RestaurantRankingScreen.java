...
public class RestaurantRankingScreen extends Screen {
    private static final net.minecraft.resources.ResourceLocation MEDAL_1 = net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("ordertocook", "textures/gui/medal_1st.png");
    private static final net.minecraft.resources.ResourceLocation MEDAL_2 = net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("ordertocook", "textures/gui/medal_2nd.png");
    private static final net.minecraft.resources.ResourceLocation MEDAL_3 = net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("ordertocook", "textures/gui/medal_3rd.png");
