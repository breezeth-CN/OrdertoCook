...
public class RestaurantRankingScreen extends Screen {
    private static final net.minecraft.util.Identifier MEDAL_1 = new net.minecraft.util.Identifier("ordertocook", "textures/gui/medal_1st.png");
    private static final net.minecraft.util.Identifier MEDAL_2 = new net.minecraft.util.Identifier("ordertocook", "textures/gui/medal_2nd.png");
    private static final net.minecraft.util.Identifier MEDAL_3 = new net.minecraft.util.Identifier("ordertocook", "textures/gui/medal_3rd.png");
