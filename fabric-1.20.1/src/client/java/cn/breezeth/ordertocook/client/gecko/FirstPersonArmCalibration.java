...
public final class FirstPersonArmCalibration {
    ...
    public static float mainX() { return MAIN_X; }
    public static float mainX(Profile profile) { return profile == Profile.ACTION ? ACTION_MAIN_X : MAIN_X; }
    public static float offX() { return OFF_X; }
    public static float offX(Profile profile) { return profile == Profile.ACTION ? ACTION_OFF_X : OFF_X; }
    public static float mainY() { return MAIN_Y; }
    public static float mainY(Profile profile) { return profile == Profile.ACTION ? ACTION_MAIN_Y : MAIN_Y; }
    public static float offY() { return OFF_Y; }
    public static float offY(Profile profile) { return profile == Profile.ACTION ? ACTION_OFF_Y : OFF_Y; }
    public static float mainZ() { return MAIN_Z; }
    public static float mainZ(Profile profile) { return profile == Profile.ACTION ? ACTION_MAIN_Z : MAIN_Z; }
    public static float offZ() { return OFF_Z; }
    public static float offZ(Profile profile) { return profile == Profile.ACTION ? ACTION_OFF_Z : OFF_Z; }
    public static float mainXRot() { return MAIN_X_ROT; }
    public static float mainXRot(Profile profile) { return profile == Profile.ACTION ? ACTION_MAIN_X_ROT : MAIN_X_ROT; }
    public static float offXRot() { return OFF_X_ROT; }
    public static float offXRot(Profile profile) { return profile == Profile.ACTION ? ACTION_OFF_X_ROT : OFF_X_ROT; }
    public static float mainYRot() { return MAIN_Y_ROT; }
    public static float mainYRot(Profile profile) { return profile == Profile.ACTION ? ACTION_MAIN_Y_ROT : MAIN_Y_ROT; }
    public static float offYRot() { return OFF_Y_ROT; }
    public static float offYRot(Profile profile) { return profile == Profile.ACTION ? ACTION_OFF_Y_ROT : OFF_Y_ROT; }
    public static float mainZRot() { return MAIN_Z_ROT; }
    public static float mainZRot(Profile profile) { return profile == Profile.ACTION ? ACTION_MAIN_Z_ROT : MAIN_Z_ROT; }
    public static float offZRot() { return OFF_Z_ROT; }
    public static float offZRot(Profile profile) { return profile == Profile.ACTION ? ACTION_OFF_Z_ROT : OFF_Z_ROT; }
