...
public class ChairBlock extends Block {
    ...
    // 与 fabric-1.21.1 ChairBlock.SEAT_HEIGHT_OFFSET 一致：玩家/SeatEntity 落座高度基准，勿只改一侧否则两版本坐姿与起身位置会分叉。
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, net.minecraft.util.Hand hand, BlockHitResult hit) {
        ...
        java.util.List<SeatEntity> seats = world.getEntitiesByClass(SeatEntity.class, searchBox, s -> s.getCommandTags().contains(OrderNpcManager.TAG_CHAIR_SEAT) && s.getCommandTags().contains(posTag));
