...
public class CustomerEntity extends ZombieEntity implements GeoEntity {
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(TEXTURE_VARIANT, 1);
        this.dataTracker.startTracking(SKIN_ACCOUNT, "");
        this.dataTracker.startTracking(SKIN_UUID, "");
        this.dataTracker.startTracking(EASTER_EGG, false);
        this.dataTracker.startTracking(ANIMATION_VARIANT, 1);
        this.dataTracker.startTracking(CUSTOMER_ID, "");
        this.dataTracker.startTracking(ACTION_STATE, ACTION_NONE);
    }
    ...
    private void tickEatEffects(int actionState, int elapsedTicks) {
        ...
        if (!this.currentActionFinishTriggered && elapsedTicks >= 118) {
            ...
            serverWorld.playSound(null, this.getBlockPos(), SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.NEUTRAL, 1.0f, 1.0f);
