...
public final class CustomerProfileLibrary {
    ...
    public record CustomerProfile(String displayName, int textureVariant, String skinAccount, String skinUuid, boolean easterEgg) {
        public Text toNameText() {
            return easterEgg ? Text.literal(displayName).formatted(Formatting.RED) : Text.literal(displayName);
        }
    }
    ...
    public static CustomerProfile createOrderProfile(ServerWorld world) {
    ...
    public static CustomerProfile createWalkInProfile(ServerWorld world, String customerName) {
        return new CustomerProfile(customerName, 0, "", "", false);
    }

    public static CustomerProfile createGuaranteedEasterEggProfile(ServerWorld world) {
    ...
    public static CustomerProfile fromNbt(NbtCompound nbt, ServerWorld world) {
    ...
    public static void writeToNbt(NbtCompound nbt, CustomerProfile profile) {
