...
public class MachineRankingState extends PersistentState {
    ...
    public static MachineRankingState get(ServerWorld world) {
        ...
        return manager.getOrCreate(MachineRankingState::fromNbt, MachineRankingState::new, "ordertocook_machine_ranking");
    }

    public static MachineRankingState fromNbt(NbtCompound nbt) {
