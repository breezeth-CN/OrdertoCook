...
public class OrderToCookMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		UseEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
			...
			if (!npc.getCommandTags().contains("otc_npc")) return ActionResult.PASS;
        ...
        UseEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            ...
            if (nbt != null) {
                ...
                nbt.putString(cn.breezeth.ordertocook.core.ModConstants.NBT_MACHINE_DIM, ((ServerWorld) world).getRegistryKey().getValue().toString());
                int machineId = 0;
