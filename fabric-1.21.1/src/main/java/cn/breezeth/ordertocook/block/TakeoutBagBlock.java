...
public class TakeoutBagBlock extends BlockWithEntity {
    public static final MapCodec<TakeoutBagBlock> CODEC = createCodec(TakeoutBagBlock::new);
    ...
    @Override
    public net.minecraft.util.ActionResult onUse(BlockState state, World world, BlockPos pos, net.minecraft.entity.player.PlayerEntity player, net.minecraft.util.hit.BlockHitResult hit) {
        ...
        world.playSound(null, pos, ModSounds.BAG_PICKUP, SoundCategory.BLOCKS, 1.0f, 1.0f);
