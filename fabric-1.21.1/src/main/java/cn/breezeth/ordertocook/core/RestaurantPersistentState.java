...
public class RestaurantPersistentState extends PersistentState {
    ...
    public static final PersistentState.Type<RestaurantPersistentState> TYPE =
            new PersistentState.Type<>(RestaurantPersistentState::new, RestaurantPersistentState::read, null);
    ...
    public static RestaurantPersistentState get(ServerWorld world) {
        ...
        return manager.getOrCreate(TYPE, "ordertocook_restaurant_stats");
    }

    public static RestaurantPersistentState read(NbtCompound nbt, RegistryWrapper.WrapperLookup lookup) {
