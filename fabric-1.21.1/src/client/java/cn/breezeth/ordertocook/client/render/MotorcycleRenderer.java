...
public class MotorcycleRenderer extends EntityRenderer<MotorcycleEntity> {
    public static final EntityModelLayer LAYER = new EntityModelLayer(Identifier.of(OrderToCookMod.MOD_ID, "motorcycle"), "main");
    private final MotorcycleModel<MotorcycleEntity> model;

    private static final Identifier DEFAULT_TEXTURE = Identifier.of(OrderToCookMod.MOD_ID, "textures/entity/motorcycle.png");
    private static final Identifier RED_TEXTURE = Identifier.of(OrderToCookMod.MOD_ID, "textures/entity/electric_motorcycle_red.png");
    private static final Identifier BLUE_TEXTURE = Identifier.of(OrderToCookMod.MOD_ID, "textures/entity/electric_motorcycle_blue.png");
    private static final Identifier YELLOW_TEXTURE = Identifier.of(OrderToCookMod.MOD_ID, "textures/entity/electric_motorcycle_yellow.png");
    private static final Identifier LIGHT_TEXTURE = Identifier.of(OrderToCookMod.MOD_ID, "textures/entity/electric_motorcycle_light.png");
    ...
    public void render(MotorcycleEntity entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
        ...
        if (entity.isLightEnabled()) {
            ...
            this.model.render(matrices, lightConsumer, LightmapTextureManager.MAX_LIGHT_COORDINATE, OverlayTexture.DEFAULT_UV, 0xFFFFFFFF);
        }
