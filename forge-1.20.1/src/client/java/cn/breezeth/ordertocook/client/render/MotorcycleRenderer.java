...
public class MotorcycleRenderer extends EntityRenderer<MotorcycleEntity> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            new ResourceLocation(ModConstants.MOD_ID, "motorcycle"), "main");
    private final MotorcycleModel<MotorcycleEntity> model;

    private static final ResourceLocation DEFAULT_TEXTURE =
            new ResourceLocation(ModConstants.MOD_ID, "textures/entity/motorcycle.png");
    private static final ResourceLocation RED_TEXTURE =
            new ResourceLocation(ModConstants.MOD_ID, "textures/entity/electric_motorcycle_red.png");
    private static final ResourceLocation BLUE_TEXTURE =
            new ResourceLocation(ModConstants.MOD_ID, "textures/entity/electric_motorcycle_blue.png");
    private static final ResourceLocation YELLOW_TEXTURE =
            new ResourceLocation(ModConstants.MOD_ID, "textures/entity/electric_motorcycle_yellow.png");
    private static final ResourceLocation LIGHT_TEXTURE =
            new ResourceLocation(ModConstants.MOD_ID, "textures/entity/electric_motorcycle_light.png");
    ...
    public void render(MotorcycleEntity entity, float yaw, float partialTick, PoseStack poseStack,
        ...
        if (entity.isLightEnabled()) {
            ...
            this.model.renderToBuffer(poseStack, lightConsumer, LightTexture.FULL_BRIGHT, OverlayTexture.NO_OVERLAY, 1.0f, 1.0f, 1.0f, 1.0f);
        }
