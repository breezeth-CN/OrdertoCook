...
public final class ModConstants {
    ...
    public static final String NBT_CUSTOMER_ID = "CustomerId";
    public static final String NBT_CUSTOMER_TEXTURE_VARIANT = "CustomerTextureVariant";
    public static final String NBT_CUSTOMER_SKIN_ACCOUNT = "CustomerSkinAccount";
    public static final String NBT_CUSTOMER_SKIN_UUID = "CustomerSkinUuid";
    public static final String NBT_CUSTOMER_EASTER_EGG = "CustomerEasterEgg";
